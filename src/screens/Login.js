...
export default function Login() {
  ...
  return (
    <div className='c1'>
      <div className='container container1 w-50 h-100%'>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            ...
            <input type="email" className="form-control w-100% bg-white text-dark" name='email' value={credentials.email} onChange={onChange} id="exampleInputEmail1" aria-describedby="emailHelp" />
